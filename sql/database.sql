...
CREATE TABLE `options`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 135 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '选项表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `options` VALUES (134, 'dict_transaction_log_details_status', '[{\"value\":\"0\",\"name\":\"失败\"},{\"value\":\"1\",\"name\":\"成功\"}]', '2025-03-13 13:46:46', '2025-03-13 13:46:46');
...
CREATE TABLE `recharges`  (
  ...
  `total_amount` decimal(20, 8) NULL DEFAULT 0.00000000,
  ...
  `error_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '错误信息',
  `created_at` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `rules`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 181 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限规则' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `rules` VALUES (169, '审核', NULL, 'plugin\\admin\\app\\controller\\WithdrawController@update', 144, '2025-03-10 20:10:27', '2025-03-21 14:52:42', NULL, 2, 0);
...
INSERT INTO `rules` VALUES (179, '浏览静态收益明细', NULL, 'plugin\\admin\\app\\controller\\MevController@staticIncomeDetail', 130, '2025-03-10 14:51:13', '2025-03-21 14:52:42', NULL, 2, 0);
INSERT INTO `rules` VALUES (180, '查询静态收益明细', NULL, 'plugin\\admin\\app\\controller\\MevController@staticIncomeDetails', 130, '2025-03-10 14:51:13', '2025-03-21 14:52:42', NULL, 2, 0);
...
CREATE TABLE `transaction_log_details`  (
  ...
  `status` tinyint(1) NULL DEFAULT 1,
  `datetime` int(10) UNSIGNED NULL DEFAULT NULL,
  `endtime` int(10) NULL DEFAULT 0 COMMENT '结束时间',
  `created_at` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id` ASC, `transaction_id` ASC) USING BTREE,
  INDEX `transaction_log_id`(`transaction_log_id` ASC) USING BTREE,
  INDEX `hash`(`transaction_hash` ASC) USING BTREE
